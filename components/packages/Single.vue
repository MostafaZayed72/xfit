<template>
    <main>
      ...
      <div class="row flex gap-5 flex-wrap justify-center ">
         <!-- IF LARGE SCREEN -->
         <div
            class="col-sm-6 col-md-4 mb-4  rounded hidden lg:block   w-1/3 main-card"
         ...
         <!-- IF SMALL AND MEDIUM SCREEN -->
         <div
            class="col-sm-6 col-md-4 mb-4  rounded  lg:hidden  w-100 main-card"
            v-for="the_package in packages?.data"
            :key="the_package.id"
         >
            <div
