      ...
      <div v-if="thePackage?.data" class="main-card rounded-xl shadow-lg p-5">
         ...
         <div v-if="!selectedBranch">
            ...
            <div class="flex flex-wrap gap-3 mb-8">
               <a
                  href="javascript:;"
                  class="bg-cyan-500 choose py-1 px-2 rounded-xl"
         ...
         <div class="mb-5">
            ...
            <input
               type="date"
               class="w-full bg-zinc-300 text-black"
         ...
         <div class="text-end">
            <ButtonsPrimary
            v-if="!memberInformationIsRequired.response.data"

               class="w-20 bg-cyan-400 choose "
            ...
            <ButtonsPrimary
            v-if="memberInformationIsRequired.response.data"
               class="w-20 bg-cyan-400 choose cursor-not-allowed"
               :isLoading="createMembershipRequest?.isLoading"
            >
               {{ $t("Confirm", "تأكيد") }}
            </ButtonsPrimary>
         ...
         <div></div>
         <div
            class="mt-4 bg-[var(--c9)] mb-5 p-5 shadow-lg rounded-xl"
            v-if="memberInformationIsRequired.response.data"
         >
            <p class="mb-3 text-[var(--c1)]">
               {{
...
// const isDisabled = ()=>{
//    if(memberInformationIsRequired.response.data){
//       return true;
//    }
//    else{
//       return false;
